        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <div class="inline-flex items-center mr-2">
                    <a
                        href="{{ route('admin.settings.website') }}#tab-cache"
                        class="inline-flex items-center px-3 py-2 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500 hover:text-red-700 hover:border-red-300 focus:outline-none focus:text-red-700 focus:border-red-300 transition duration-150 ease-in-out"
                    >
                        <i class="mdi mdi-database-refresh-outline mr-1"></i>
                        <span class="max-md:hidden">Cache</span>
                    </a>
                </div>
                ...
                <div class="inline-flex items-center">
                    ...
                    >
                        <span class="mr-2 max-md:hidden">Menü</span>
                        <i class="mdi mdi-menu md-24 md:hidden"></i>
                    </a>
                </div>
            ...
            <div class="-me-2 flex items-center sm:hidden">
                ...
                <a
                    href="{{ route('admin.settings.website') }}#tab-cache"
                    class="inline-flex items-center px-3 py-2 mr-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500 hover:text-red-700 hover:border-red-300 focus:outline-none focus:text-red-700 focus:border-red-300 transition duration-150 ease-in-out"
                >
                    <i class="mdi mdi-database-refresh-outline md-24"></i>
                </a>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <div class="flex flex-col space-y-2">
                        ...
                        <a href="{{ route('admin.settings.website') }}#tab-cache" class="text-gray-700 hover:text-red-700">
                            <i class="mr-1 mdi mdi-database-refresh-outline"></i>Cache
                        </a>
