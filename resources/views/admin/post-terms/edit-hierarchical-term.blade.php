        ...
        <div class="p-2">
            ...
            <h3>
                ...
                <a
                    ...
                    target="_self"
                >{{ __(Str::ucfirst($taxonomy_name)) }}</a>
            ...
            <form
                method="post"
                action="{{ route('taxonomy.update',['taxonomy_name'=>$taxonomy_name,'term'=>$term->id]) }}"
            >
                ...
                <div class="p-2 w-full rounded">
                    ...
                    @foreach($supportedLocales as $locale)
                        ...
                        <div class="w-full my-6 p-4 border rounded bg-gray-50">
                            ...
                            <input
                                ...
                                value="{{ $nameValue }}"
                                class="mt-2 mb-3 w-full border border-gray-300 rounded"
                                placeholder="Keresőbarát név ({{ strtoupper($locale) }})"
                            >
                    ...
                    @if($hierarchical)
                        ...
                        <div class="w-full my-4 p-4 border rounded">
                            ...
                            @if(!empty($term->getMetaValue('head_image')))

                                <div class="w-full flex justify-center">

                                    <img
                                        class="my-4 max-h-[600px] rounded"
                                        src="{{ $term->getMetaValue('head_image_url') }}"
                                    >
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-2 items-center">
                                ...
                                <div class="p-2">
                                    ...
                                    <input
                                        ...
                                        name="head_image"
                                        value="{{ old('head_image',$term->getMetaValue('head_image')) }}"
                                    >
